...
const BulletinAllPosts = () => {
    ...
    const { boardFilter, searchKeyword } = (0, recoil_1.useRecoilValue)(atoms_1.bulletinSearchState);
            ...
            <react_router_dom_1.Link to={`/bulletin/${post._id}`} state={{ id: post._id }}>
              ...
              <BulletinAllPosts_1.Row>
                ...
                <BulletinAllPosts_1.Icon>
                  <BulletinAllPosts_1.Row style={{ color: isDark ? "yellow" : "blue" }}>
                    <ai_1.AiOutlineLike />
                    {post.likes.length}
                  </BulletinAllPosts_1.Row>
                </BulletinAllPosts_1.Icon>
...
exports.default = BulletinAllPosts;
