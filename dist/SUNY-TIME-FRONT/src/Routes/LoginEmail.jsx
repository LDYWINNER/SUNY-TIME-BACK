...
function LoginEmail() {
    ...
    const onValid = (data) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (data.loginConfirmation === String(authNum)) {
            setError("loginConfirmation", { message: "Login Confirmation Failed" }, { shouldFocus: true });
        }
        //login user
        try {
    ...
    return (<Register_1.Wrapper className="full-page" bgImage={bgImage}>
      <form className="form" onSubmit={handleSubmit(onValid)}>
        ...
        <h3>Login</h3>
        <react_2.Progress hasStripe value={50}/>
        {values.formSuccess === true && (<Components_1.Alert message="Logged In! Redirecting..." ifSuccess={true}/>)}
        ...
        <div className="form-row">
          ...
          <input type="text" className="form-input" {...register("loginConfirmation", { required: true })} placeholder="EMAIL CONFIRMATION"></input>
        </div>

        {((_a = errors === null || errors === void 0 ? void 0 : errors.loginConfirmation) === null || _a === void 0 ? void 0 : _a.message) && (<Components_1.Alert message={errors.loginConfirmation.message}/>)}
