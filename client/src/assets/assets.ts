...
export const quotes = [
  ...
  {
    quote:
      "창업가들은 세상 모두가 안 될 거라고 말하는 일이 가능하다고 주장하는 사람이다.",
    author: "패스트트랙아시아 박지웅",
  },
  {
    quote:
  ...
  {
    quote:
      "지금 당장 꽃을 피우지 못했다고 해서 좌절하지 마세요. 친구와 비교하지도 마세요. 지금은 그저 나의 계졀이 아닌 것뿐이에요.",
  ...
  {
    quote:
      "자는 시간은 중요하지 않다. 중요한 건 깨어 있는 시간을 어떻게 보내는지다.",
    author: "@motive_write",
  },
  {
  ...
  {
    quote:
      "진정한 용기는 두려움이 없는 상태가 아니라 두려움에도 불구하고 행동하는 것이다.",
    author: "요한 볼프강 폰 괴테",
  },
  {
    quote:
      "자신의 의견이 별난 게 아닐까 두려워 마라. 오늘날 인정받는 모든 의견은 한때는 엉뚱한 것으로 취급받았다.",
    author: "버트런드 러셀",
  },
  {
